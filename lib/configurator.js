...
function Configurator () {
	...
	properties.predefinedRules = {
		...
		topLevelDomains: prefs.topLevelDomains.split(';'),
    ...
    simplePrefs.on('topLevelDomains', function () {
		properties.predefinedRules.topLevelDomains = prefs.topLevelDomains.split(';');
	});
    ...
    if (preferencesService.get('extensions.linkificator@markapola.widgetMiddleClick', 'toggle') === 'show') {
        preferencesService.reset('extensions.linkificator@markapola.widgetMiddleClick');
    }
    if (preferencesService.get('extensions.linkificator@markapola.widgetRightClick', 'none') === 'show') {

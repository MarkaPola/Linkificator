...
function Configurator () {
    ...
    const PROTOCOLS = "h..p~http#2;h..ps~https#2;ftp~ftp#2;news~news#0;nntp~nntp#2;telnet~telnet#2;irc~irc#2;file~file#3;about~about#0";
	...
	// raw data management
	currents.raw = {};
    Object.defineProperty (currents.raw, "all", {get:  function () { 
		return {current: currents.rawData, defaults: defaults.rawData}; },
                                                 set : function (data) {
        currents.rawData = data.current;
    ...
    Object.defineProperty (currents.raw, "protocols", {get:  function () { 
		return currents.rawData.protocols; },
                                                       set : function (data) {
        currents.rawData.protocols = data;
		currents.protocols = splitProtocols(currents.rawData.protocols);
	}});
    Object.defineProperty (currents.raw, "subdomains", {get:  function () { 
		return currents.rawData.subdomains; },
                                                       set : function (data) {
        currents.rawData.subdomains = data;
		currents.subdomains = splitSubdomains(currents.rawData.subdomains);
	}});
    Object.defineProperty (currents.raw, "excludedElements", {get:  function () { 
		return currents.rawData.excludedElements; },
                                                              set : function (data) {

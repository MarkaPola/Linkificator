...
function Configurator () {
    ...
    const PREF_PREFIX = "extensions."+self.id+".";
	...
	const SYNC_PREFIX = "services.sync.prefs.sync."+PREF_PREFIX;
	const SYNC_PROPERTIES = ["manual", 
    ...
    simplePrefs.on('manual', function () {
		properties.manual = prefs.manual;
	});
    ...
    simplePrefs.on('useBrandTLDs', function () {
		properties.predefinedRules.topLevelDomains = splitTopLevelDomains(prefs.useGTLDs ? prefs.gTLDs : undefined,
                                                                          prefs.useCcTLDs ? prefs.ccTLDs : undefined,
                                                                          prefs.useGeoTLDs ? prefs.geoTLDs : undefined,
                                                                          prefs.useCommunityTLDs ? prefs.communityTLDs : undefined,
    ...
    simplePrefs.on('brandTLDs', function () {
		properties.predefinedRules.topLevelDomains = splitTopLevelDomains(prefs.useGTLDs ? prefs.gTLDs : undefined,
                                                                          prefs.useCcTLDs ? prefs.ccTLDs : undefined,
                                                                          prefs.useGeoTLDs ? prefs.geoTLDs : undefined,
                                                                          prefs.useCommunityTLDs ? prefs.communityTLDs : undefined,
    ...
    preferencesService.reset(PREF_PREFIX+'displayWidget');

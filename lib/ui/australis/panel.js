...
function createView (trait, document) {
    ...
    document.getElementById("PanelUI-history").parentElement.appendChild(view);
    ...
    unload(function () {
        document.getElementById("PanelUI-history").parentElement.removeChild(view);

...
const WidgetTrait = function (options) {
    ...
    this.woptions = {
        onCreated: (function (node) {
            this.windows.set(windows.browserWindows.activeWindow, node.ownerDocument.defaultView);
            this.windows.set(node.ownerDocument.defaultView, windows.browserWindows.activeWindow);
...
exports.Widget = function (options) {
    ...
    return {
        ...
        getView: function (window) {
            let win = window instanceof windows.BrowserWindow ? wt.windows.get(window) : window;
            let instance = win ? CustomizableUI.getWidget(wt.woptions.id).forWindow(win) : null;

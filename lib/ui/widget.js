...
var validOptions = ['onMouseover', 'onClick', 'onMiddleclick', 'onRightclick',  'id', 'type', 'panel', 'label', 'tooltip'];

if (useAustralis) {
    validOptions.push('icon', 'stylesheet', 'removable', 'overflows', 'shortcutId', 'showInPrivateBrowsing');
} else {

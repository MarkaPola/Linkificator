		...
		if (settingsWindow) {
			...
			if (parameters.changed) {
				if (parameters.changed.protocols) {
					properties.raw.protocols = parameters.changed.protocols;
				} else if (parameters.changed.subdomains) {
					properties.raw.subdomains = parameters.changed.subdomains;
				} else if (parameters.changed.excludedElements) {
					properties.raw.excludedElements = parameters.changed.excludedElements;
				}
			}
		}
	});

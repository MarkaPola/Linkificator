        ...
        this.menu = menus.Menu({
            ...
            content: ['panelview', {flex: '1'},
                      ...
                      ['toolbarbutton', {key: 'manage',
                                         ...
                                         tabindex: '0',
                                         label: this.locale.exclude,
                                         image: data.url("resources/link-excluded.png"),
                                         oncommand: 'PanelUI.hide();',
                                         command: function (event) {
                                             manage();
                                         }}],
            ...
            onShow: (function (menu) {
                ...
                if (state == 'excluded') {
                    ...
                    menu.manage.image = data.url("resources/link-on.png");
                } else {
                    menu.manage.label = this.locale.exclude;
                    menu.manage.image = data.url("resources/link-excluded.png");
                }
                ...
                if (state != 'processed') {
                    ...
                    menu.linkify.image = data.url("resources/link-on.png");
                }
            }).bind(this)
        });

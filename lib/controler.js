    ...
    var observer = {
        ...
        observe: function (aSubject, aTopic, aData) {
            if (aTopic == "addon-options-displayed" && aData == "linkificator@markapola") {
                ...
                aSubject.getElementById('settings.prefs.export').addEventListener('click', exportSettings.bind(this));
                ...
                aSubject.getElementById('settings.prefs.import').addEventListener('click', importSettings.bind(this));

                sync.addEventListener('click', (function() {
                    prefs.sync = sync.getAttribute("checked") == "true" ? false : true;
                }).bind(this));

                aSubject.getElementById('settings.prefs.defaults').addEventListener('click', (function() {

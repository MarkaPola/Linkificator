...
function Controler (configurator) {
    ...
    function Widget () {
        ...
        this.menu = menus.Menu({
            ...
            onShow: (function (menu) {
                ...
                menu.toggle.label = active ? this.locale.disable : this.locale.enable;
                menu.manage.label = state == 'excluded' ? this.locale.include : this.locale.exclude;
                menu.manage.disabled = state != 'excluded' && state != 'processed';
                menu.linkify.disabled = state != 'processed';
            }).bind(this)
        });
	...
	function manage () {
		...
		if (isActive() && isValidDocument(activeTab) && configurator.linkifyURL(activeTab.url)) {
